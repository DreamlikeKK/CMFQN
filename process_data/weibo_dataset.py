...
class weibo_dataset(data.Dataset):
    ...
    def __init__(self,
                 dataset='weibo_dataset', image_size=224, is_train=True,
                 ):
        ...
        wb = openpyxl.load_workbook(f"{full_path}/{'train' if self.is_train else 'test'}_datasets_news_data.xlsx")
    ...
    def __getitem__(self, index):
        ...
        GT_path = images
        relative_path = self.root_path.lstrip('/')
        img_f_path = 'rumor_images' if label==1 else 'nonrumor_images'
